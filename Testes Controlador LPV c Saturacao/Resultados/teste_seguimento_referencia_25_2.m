...
%%
figure
plot(t(60:710),h3(11:661)*1e-2);
hold on
plot(t(60:710),h3f(11:661));
plot(t(60:710),sp_h3(11:661)*1e-2);
xlabel('Tempo(s)')
ylabel('Altura(cm)')
xlim([195.7 5585])
grid on
...
%%
figure
plot(t(60:710),h4(11:661)*1e-2);
hold on
plot(t(60:710),h4f(11:661));
plot(t(60:710),sp_h4(11:661)*1e-2);
xlabel('Tempo(s)')
ylabel('Altura(cm)')
xlim([195.7 5585])
grid on
...
xlim([195.7 5585])
subplot(3,1,3)
plot(t(60:710),u_s(11:661))
hold on
plot(t(60:710),u(11:661))
...
% hold on
x_ = [(h4f(11:661) - sp_h4(11:661)*1e-2);(h3f(11:661) - sp_h3(11:661)*1e-2);x_i(11:661)];
